...
class Profile3 extends Component {
  ...
  state = {
    tabs: {
      index: 0,
      routes: [
        { key: '1', title: 'SCORE', count: '99%' },
        { key: '3', title: 'PLAYED', count: 21 },
        { key: '2', title: 'JOINED', count: 6 },
      ],
    },
    postsMasonry: {},
  }
  ...
  _renderLabel = props => ({ route, index }) => {
    ...
    const outputRange = inputRange.map(inputIndex => (inputIndex === index ? 'black' : 'gray'));
  ...
  renderContactHeader = () => {
    const {
      avatar, avatarBackground, name, bio,
    } = this.props;
    return (
